...
#define WLED_AP_SSID "MakersxMasTree"
#define WLED_AP_PASS "xMasTree"


#define CLIENT_SSID "makersupv"
#define CLIENT_PASS "makersupv1234"
//#define MAX_LEDS 1500       // Maximum total LEDs. More than 1500 might create a low memory situation on ESP8266.
#define MDNS_NAME "xmastree"    // mDNS hostname, ie: *.local
